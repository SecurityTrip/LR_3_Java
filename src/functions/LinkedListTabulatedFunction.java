...
public class LinkedListTabulatedFunction{
    ...
    protected FunctionNode addNodeToTail() {
        ...
        setAvailableNumberOfPoints(getAvailableNumberOfPoints() + 1);
        return node;
    ...
    public void setAvailableNumberOfPoints(int count) {
    ...
    public void deletePoint(int index) throws FunctionPointIndexOutOfBoundsException {
        ...
        if (getAvailableNumberOfPoints() <= 2)
    ...
    protected boolean isCorrectPosition(int index) {
        return index >= 0 && index < getAvailableNumberOfPoints();
    }
